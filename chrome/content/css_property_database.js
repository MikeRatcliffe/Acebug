//'-moz-appearance'.replace(/-./g,function(match) match[1].toUpperCase());
//'MozAppearance'.replace(/[A-Z]/g, function(match) '-'+match.toLowerCase());
...
var propValues = {
    ...
    angle:['deg','grad','rad','degree'],
    length:['px','em','ex','ch','mm','in','pt','pc']
};
...
var gCSSProperties = {
    "-moz-appearance": {
        ...
        initial_values: [ "none" ],
        other_values: ["radio", "checkbox", "button-bevel", "toolbox", "toolbar", "toolbarbutton", "toolbargripper", "dualbutton", "toolbarbutton-dropdown", "button-arrow-up", "button-arrow-down", "button-arrow-next", "button-arrow-previous", "separator", "splitter", "statusbar", "statusbarpanel", "resizerpanel", "resizer", "listbox", "listitem", "treeview", "treeitem", "treetwisty", "treetwistyopen", "treeline", "treeheader", "treeheadercell", "treeheadersortarrow", "progressbar", "progressbar-vertical", "progresschunk", "progresschunk-vertical", "tab", "tabpanels", "tabpanel", "tab-scroll-arrow-back", "tab-scroll-arrow-forward", "tooltip", "spinner", "spinner-upbutton", "spinner-downbutton", "spinner-textfield", "scrollbarbutton-up", "scrollbarbutton-down", "scrollbarbutton-left", "scrollbarbutton-right", "scrollbartrack-horizontal", "scrollbartrack-vertical", "scrollbarthumb-horizontal", "scrollbarthumb-vertical", "sheet", "textfield", "textfield-multiline", "caret", "searchfield", "menubar", "menupopup", "menuitem", "checkmenuitem", "radiomenuitem", "menucheckbox", "menuradio", "menuseparator", "menuarrow", "menuimage", "menuitemtext", "menulist", "menulist-button", "menulist-text", "menulist-textfield", "scale-horizontal", "scale-vertical", "scalethumb-horizontal", "scalethumb-vertical", "scalethumbstart", "scalethumbend", "scalethumbtick", "groupbox", "checkbox-container", "radio-container", "checkbox-label", "radio-label", "button-focus", "-moz-win-media-toolbox", "-moz-win-communications-toolbox", "-moz-win-browsertabbar-toolbox", "-moz-win-mediatext", "-moz-win-communicationstext", "-moz-win-glass", "-moz-win-borderless-glass", "-moz-window-titlebar", "-moz-window-titlebar-maximized", "-moz-window-frame-left", "-moz-window-frame-right", "-moz-window-frame-bottom", "-moz-window-button-close", "-moz-window-button-minimize", "-moz-window-button-maximize", "-moz-window-button-restore", "-moz-window-button-box", "-moz-window-button-box-maximized", "-moz-mac-unified-toolbar"],
        invalid_values: []
    },
